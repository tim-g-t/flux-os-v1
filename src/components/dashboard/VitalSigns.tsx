...
export const VitalSigns: React.FC<VitalSignsProps> = ({ selectedMetrics, onMetricToggle }) => {
  ...
  if (loading || !latestVitals) {
    return (
      <section className="w-[80%] ml-5 max-md:w-full max-md:ml-0">
  ...
  return (
    <section className="w-[80%] ml-5 max-md:w-full max-md:ml-0">
      <div className="bg-black w-full mx-auto px-8 py-5 pb-3 rounded-3xl max-md:max-w-full max-md:mt-10 max-md:px-5">
        ...
        <div className="flex items-stretch gap-[21px] flex-wrap mt-2 mb-1 max-md:max-w-full">
          <MetricCard
