...
export const RiskScores: React.FC = () => {
  ...
  return (
    <section className="bg-black flex w-full flex-col items-stretch text-white mt-6 pt-4 pb-[29px] px-[30px] rounded-[24px_24px_0px_0px] max-md:max-w-full max-md:mr-1 max-md:px-5">
      ...
      <div className="bg-[rgba(223,0,4,0.34)] flex items-start gap-[25px] text-base font-normal flex-wrap mt-2.5 pl-2.5 pr-20 py-[3px] rounded-[30px] max-md:pr-5">
      ...
      <div className="flex items-stretch gap-[26px] text-base font-normal flex-wrap ml-2.5 mt-[13px]">
